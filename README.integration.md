...
- **Integration Plan**: [Mini Photo Editor Integration Guide](../../RexxJS/reference/38-mini-photo-editor-integration.md)
- **General Patterns**: [App Integration Patterns](../../RexxJS/reference/37-app-integration-patterns.md)
